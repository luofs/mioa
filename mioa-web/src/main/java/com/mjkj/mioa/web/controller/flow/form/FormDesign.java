 ...
 * File Name:FormDesign.java  
 * Package Name:com.mjkj.mioa.web.controller.flow.form  
 * Date:2018年1月15日下午4:10:58  
 * Copyright (c) 2018, 597668255@qq.com All Rights Reserved.  
 *  
*/  
  
package com.mjkj.mioa.web.controller.flow.form;  
...
public class FormDesign
{
    ...
    fields 字段总数
*/
public void  parseForm(String originalHtml,int $fields)
{
    //获取标签
    ...
    */
    ...
    Matcher m = p.matcher(originalHtml);
    List<String> matchList = new ArrayList<>();
    while (m.find()) {
    	System.out.println(m.group());
    	matchList.add(m.group());
    }
    //preg_match_all($preg,originalHtml,$temparr);
...
//
//                //parse
//                originalHtml = self::str_replace_once($plugin,$attr_arr_all['content'],originalHtml);
...
/*只替换一次*/
//public String str_replace_once($needle,$replace,$haystack)
//{
