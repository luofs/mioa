 ...
 * Date:     2017年11月23日 上午11:52:43 
 * @author   fsluo  
 * @version    
 * @since    JDK 1.7 
 * @see        封装了一些采用HttpClient发送HTTP请求的方法
 */
...
public class HttpClientUtil {  
    ...
    /** 
     * 发送HTTPS_POST请求 
     * @see 该方法为<code>sendPostSSLRequest(String,Map<String,String>,String,String)</String,String></code>方法的简化方法 
     * @see 该方法在对请求数据的编码和响应数据的解码时,所采用的字符集均为UTF-8 
     ...
     * @param reqURL 请求地址 
     * @param params 发送到远程主机的正文数据,其数据类型为<code>java.util.Map<string, string=""></string,></code> 
